...
def get_helm_registry(cmd, config_dp_endpoint, dp_endpoint_custom=None, release_train_dogfood=None):
    # Setting uri
    ...
    if dp_endpoint_custom:
        get_chart_location_url = "{}/azure-arc-k8sagents/GetLatestHelmPackagePath?api-version=2019-11-01-preview".format(dp_endpoint_custom)
